 ...
 * Temáticas: String 
 *  
 * Idea: Dada una secuencia de caracteres contar la cantidad de vocales y 
 * consonantes tiene la secuencias  
 * . 
 */
import java.io.*;
import java.math.*;
...
public class Main {
	...
	public void solve() throws Exception {
	    ...
	    for(int i=0;i<sequences.length();i++) {
	    	if(Character.isLetter(sequences.charAt(i))){
	    		if(isVolwels(sequences.charAt(i)))
	    			wolvels++;
	    		else
	    			notWolvels++;
	    	}
